...
function EventDetail(props) {
  ...
  const { data: organizer, isLoading, error } = useFetchOrganizerByEventId(eventId);
  ...
  const decodeDescription = (description) => {
    try {
      ...
      const decodedContent = decode(description);
                ...
                <div className="event-detail-content">
                  ...
                  <div className="event-detail-long-content">
                    <div dangerouslySetInnerHTML={{ 
                      __html: decodeDescription(event?.description) 
                    }} />
                  </div>
                </div>
                <div className="event-detail-content">
                  ...
                  <div>
                    {event.organizationTickets.map((ticket, index) => (
                      <TicketComponent key={ticket.id || index} ticket={ticket} />
                    ))}
                  </div>
                </div>
                <div className="event-detail-content">
                  {isLoading ? (
                    ...
                    <div>Error loading organizer</div> // Error state  
                  ) : organizer ? (
                    // Render organizer info
                    <OrganizerInfo
                      ref={organizationRef}
